...
OPENSSL_EXPORT int BN_MONT_CTX_set(BN_MONT_CTX *mont, const BIGNUM *mod,
                                   BN_CTX *ctx);
// BN_MONT_CTX_set_use_rns sets the use_rns flag in the Montgomery context.
// It returns one on success and zero on error.
OPENSSL_EXPORT int BN_MONT_CTX_set_use_rns(BN_MONT_CTX *mont, int use_rns);

// BN_MONT_CTX_enable_drns enables DRNS for the Montgomery context.
// It returns one on success and zero on error.
OPENSSL_EXPORT int BN_MONT_CTX_enable_drns(BN_MONT_CTX *mont);
